...
<?php
    /*if($cfg && ($page = $cfg->getLandingPage()))
        ...
        echo  '<h1>'.__('Welcome to NMDR Support Center').'</h1>';
    ?>
<p>The NMDR is a system which integrates malaria data analysis, automates the generation of customized outputs and generates timely reports for program management, monitoring and evaluation. <br />
